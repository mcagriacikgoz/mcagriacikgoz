...
- **Data Integrity:** Implementation of Backup & Recovery strategies using **Veeam** and **Acronis**.
- **Automation:** Reducing operational overhead through advanced **PowerShell** and **Bash** scripting.
- **DevOps Culture:** Integrating "Infrastructure as Code" (IaC) and modern CI/CD workflows into enterprise structures.

---

### 📜 Education & Certifications
- 🎓 **B.S. Management Information Systems (MIS)** - Bartun University
- 🏆 **Intel Cloud DevOps Certification** (Intel Partner Technical Pro - Advanced)
- 🛡️ **Acronis M365 Technical Certification**
